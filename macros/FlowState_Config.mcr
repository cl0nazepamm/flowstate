...
(
    ...
    fn writeConfig path pp ps subobj tabshader light = (
        ...
        if tabshader do format "TabShader=1\n" to:f
    ...
    (
        ...
        (
            ...
            checkbox chk_tabshader "Tab Key Opens PowerShader in SME" checked:false
        ...
        (
            ...
            chk_tabshader.checked = readFlag iniPath "TabShader" default:false
            chk_lighttheme.checked = readFlag iniPath "LightTheme" default:false
        )

        on btn_save pressed do
        (
            writeConfig iniPath chk_powerparams.checked chk_powershader.checked chk_subobj.checked chk_tabshader.checked chk_lighttheme.checked
